    ...
    public class Comment
    {
        ...
        public int GetWorkCount(int id)
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
                ...
                return cn.ExecuteScalar<int>(sql, new { wokId = id });
            }
        }
        ...
        public int Update(Model.Comment comment)
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
                string sql = "update Comment set CommentContent=@CommentContent,CommentTime=@CommentContent where commmentID=@commentID";
